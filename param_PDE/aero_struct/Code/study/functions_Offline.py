...
import sys
sys.path.append('..')
from mesh.define_geo.define_geo import airbus_wing
from mesh.create_FEM_mesh.create_FEM_mesh import create_FEM_mesh
from mesh.create_VLM_mesh.create_VLM_mesh import create_VLM_mesh
...
def create_mesh_files(n_ribs_1,n_ribs_2):
    ...
    #Creating a file .msh
    subprocess.call(['/Users/ydli/Desktop/SFE/Codes/gmsh-3.0.6/build/gmsh', VLM_geo, '-2'])
    subprocess.call(['/Users/ydli/Desktop/SFE/Codes/gmsh-3.0.6/build/gmsh', FEM_geo, '-2'])
